...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { cantidad: @concept.cantidad, nombre: @concept.nombre, signo: @concept.signo, user_id: @concept.user_id, uuid: @concept.uuid }
    end
  ...
  test "should update concept" do
    patch :update, id: @concept, concept: { cantidad: @concept.cantidad, nombre: @concept.nombre, signo: @concept.signo, user_id: @concept.user_id, uuid: @concept.uuid }
    assert_redirected_to concept_path(assigns(:concept))
  end
